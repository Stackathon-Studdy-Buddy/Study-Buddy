...
const styles = StyleSheet.create({
  ...
  top: "35%",
  left:" 25%",
  background: l`inear-gradient(to bottom, rgba(255,255,255,0.15) 0%, rgba(0,0,0,0.15) 100%), radial-gradient(at top center, rgba(255,255,255,0.40) 0%, rgba(0,0,0,0.40) 120%) #989898`,
  padding: 15,
  paddingTop:17
