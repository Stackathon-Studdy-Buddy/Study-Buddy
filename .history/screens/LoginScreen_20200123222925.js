...
constructor(props){
  ...
  render(){
    ...
    return(
      <ImageBackground source={`https://st2.depositphotos.com/5044661/10513/v/950/depositphotos_105138180-stock-illustration-various-colored-dots-connected-with.jpg`} style={styles.backgroundImage} >
